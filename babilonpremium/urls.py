...
urlpatterns = [
    ...
    path('', MainView.as_view(), name="main_view_id"),
    path('addclient/', AddClientView.as_view(), name="addclient"),
    path('addclientnewaddress/<int:pk>',
         AddClientNewAddressView.as_view(),
         name="addclientnewaddress"),
    path('edit_address/<int:pk>',
         EditAddressView.as_view(),
         name="edit_address"),
    path('del_address/<int:pk>',
         DelAddressView.as_view(),
         name="delclientnewaddress"),
    path('add_new_order_local/',
         AddNewOrderLocalCashView.as_view(),
         name="add_new_order_local"),
    path('add_client_to_order/<int:pk>/<int:address>',
         AddClientToOrder.as_view(),
         name="add_client_to_order"),
    path('products/', ProductsView.as_view(), name="products"),
    path('add_new_order_outside/',
         AddNewOrderOutsideView.as_view(),
         name="add_new_order_outside"),
    path('clients/', ClientsView.as_view(), name="clients"),
    path('client/<int:pk>', ClientView.as_view(), name="client"),
    path('add_new_order_driver/',
    ...
    path('change_topps/<int:pk>/<int:modyfi>/',
         ...
         name="change_topps"),
    path('add_toops_freestyle/<int:pk>/',
         AddToppsFreeStyleView.as_view(),
         name="add_freestyle"),
    path('add_to_order_freestyle/<int:pk>/',
         AddToOrderFreeStyleView.as_view(),
         name="add_freestyle"),
    path('half_pizza/<int:pk>/<int:modyfi>/',
         Secend_Half_Pizza_SearchView.as_view(),
         name="add_secend_halfpizza"),
    path('add_secend_halfpizza/<int:first_part>/<int:secend_part>/',
         Firts_And_Secend_Half_PizzaView.as_view(),
         name="first_and_secend_halfpizza"),
    path('change_topps_firstpart_pizza/<int:part>/',
         ChangeToppsHalfPizzaView.as_view(),
         name="change_topps_half_pizza_first_part"),
    path('change_topps_secendtpart_pizza/<int:part>/',
         ChangeToppsHalfPizza_Part2View.as_view(),
         name="change_topps_half_pizza_secend_part"),
    #     path('change_topps/', ChangeToppView.as_view(), name="change_topp"),
    path('close_order/<int:pk>', CloseOrderView.as_view(), name="close_order"),
    path('close_order/', CloseOrderNoneView.as_view(),
         name="close_order_none"),
